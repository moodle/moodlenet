...
checkout {{=it.fromLocalOrg ? 'site' :'sender profile'}} here
{{=it.senderProfileUrl}}`
                  ...
                  <td style="text-align: center">
                    <div class="text-author">
                      <span class="position"
                        >{{=it.msgText}}</span
                      >
                      <p style="margin: 25px 0"><a href={{=it.senderProfileUrl}} class="btn btn-primary">{{=it.fromLocalOrg ? 'Visit Site' :'Sender profile'}}</a></p>
                    </div>
                  </td>
                </tr>
              </table>
