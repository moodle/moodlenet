...
export type ResolversTypes = {
  ...
  CreateEdgeMutationSuccess: ResolverTypeWrapper<
    Omit<Types.CreateEdgeMutationSuccess, 'edge'> & { edge: ResolversTypes['Edge'] }
  >
  ...
  CreateNodeMutationSuccess: ResolverTypeWrapper<
    Omit<Types.CreateNodeMutationSuccess, 'node'> & { node: ResolversTypes['Node'] }
  >
  ...
  Edge:
    | ResolversTypes['Bookmarked']
    | ResolversTypes['Created']
    | ResolversTypes['Features']
    | ResolversTypes['Follows']
    | ResolversTypes['Likes']
    | ResolversTypes['Pinned']
  ...
  EditEdgeMutationSuccess: ResolverTypeWrapper<
    Omit<Types.EditEdgeMutationSuccess, 'edge'> & { edge?: Types.Maybe<ResolversTypes['Edge']> }
  >
  ...
  EditNodeMutationSuccess: ResolverTypeWrapper<
    Omit<Types.EditNodeMutationSuccess, 'node'> & { node?: Types.Maybe<ResolversTypes['Node']> }
  >
  ...
  INode:
    ...
    | ResolversTypes['FileFormat']
    | ResolversTypes['IscedField']
    | ResolversTypes['IscedGrade']
...
export type ResolversParentTypes = {
  ...
  Edge:
    | ResolversParentTypes['Bookmarked']
    | ResolversParentTypes['Created']
    | ResolversParentTypes['Features']
    | ResolversParentTypes['Follows']
    | ResolversParentTypes['Likes']
    | ResolversParentTypes['Pinned']
  EditCollectionInput: Types.EditCollectionInput
  EditEdgeInput: Types.EditEdgeInput
  EditEdgeMutationError: Types.EditEdgeMutationError
  EditEdgeMutationPayload:
    | ResolversParentTypes['EditEdgeMutationSuccess']
    | ResolversParentTypes['EditEdgeMutationError']
  EditEdgeMutationSuccess: Omit<Types.EditEdgeMutationSuccess, 'edge'> & {
    edge?: Types.Maybe<ResolversParentTypes['Edge']>
  }
  EditNodeInput: Types.EditNodeInput
  EditNodeMutationError: Types.EditNodeMutationError
  EditNodeMutationPayload:
    | ResolversParentTypes['EditNodeMutationSuccess']
    | ResolversParentTypes['EditNodeMutationError']
  EditNodeMutationSuccess: Omit<Types.EditNodeMutationSuccess, 'node'> & {
    node?: Types.Maybe<ResolversParentTypes['Node']>
  }
  EditProfileInput: Types.EditProfileInput
  EditResourceInput: Types.EditResourceInput
  ...
  INode:
    ...
    | ResolversParentTypes['FileFormat']
    | ResolversParentTypes['IscedField']
    | ResolversParentTypes['IscedGrade']
    ...
    | ResolversParentTypes['ResourceType']
...
export type BookmarkedResolvers<
  ContextType = Context,
  ParentType extends ResolversParentTypes['Bookmarked'] = ResolversParentTypes['Bookmarked'],
> = {
...
> = {
  ...
  _rel?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<Types.Collection_RelArgs, 'type' | 'target'>
  >
  _relCount?: Resolver<
    ResolversTypes['Int'],
    ParentType,
    ContextType,
    RequireFields<Types.Collection_RelCountArgs, 'type' | 'target'>
  >
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>
}
...
export type CreateSessionResolvers<
  ContextType = Context,
  ParentType extends ResolversParentTypes['CreateSession'] = ResolversParentTypes['CreateSession'],
> = {
...
> = {
  __resolveType?: TypeResolveFn<
    'Bookmarked' | 'Created' | 'Features' | 'Follows' | 'Likes' | 'Pinned',
    ParentType,
    ContextType
  >
}

export type EditEdgeMutationErrorResolvers<
  ContextType = Context,
  ParentType extends ResolversParentTypes['EditEdgeMutationError'] = ResolversParentTypes['EditEdgeMutationError'],
> = {
...
export type EditEdgeMutationPayloadResolvers<
  ContextType = Context,
  ParentType extends ResolversParentTypes['EditEdgeMutationPayload'] = ResolversParentTypes['EditEdgeMutationPayload'],
> = {
  __resolveType?: TypeResolveFn<'EditEdgeMutationSuccess' | 'EditEdgeMutationError', ParentType, ContextType>
}

export type EditEdgeMutationSuccessResolvers<
  ContextType = Context,
  ParentType extends ResolversParentTypes['EditEdgeMutationSuccess'] = ResolversParentTypes['EditEdgeMutationSuccess'],
> = {
  edge?: Resolver<Types.Maybe<ResolversTypes['Edge']>, ParentType, ContextType>
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>
}

export type EditNodeMutationErrorResolvers<
  ContextType = Context,
  ParentType extends ResolversParentTypes['EditNodeMutationError'] = ResolversParentTypes['EditNodeMutationError'],
> = {
...
export type EditNodeMutationPayloadResolvers<
  ContextType = Context,
  ParentType extends ResolversParentTypes['EditNodeMutationPayload'] = ResolversParentTypes['EditNodeMutationPayload'],
> = {
  __resolveType?: TypeResolveFn<'EditNodeMutationSuccess' | 'EditNodeMutationError', ParentType, ContextType>
}

export type EditNodeMutationSuccessResolvers<
  ContextType = Context,
  ParentType extends ResolversParentTypes['EditNodeMutationSuccess'] = ResolversParentTypes['EditNodeMutationSuccess'],
> = {
...
export type FileFormatResolvers<
  ContextType = Context,
  ParentType extends ResolversParentTypes['FileFormat'] = ResolversParentTypes['FileFormat'],
> = {
  ...
  _rel?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<Types.FileFormat_RelArgs, 'type' | 'target'>
  >
  _relCount?: Resolver<
    ResolversTypes['Int'],
    ParentType,
    ContextType,
    RequireFields<Types.FileFormat_RelCountArgs, 'type' | 'target'>
  >
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>
}
...
> = {
  ...
  _rel?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<Types.INode_RelArgs, 'type' | 'target'>
  >
  _relCount?: Resolver<
    ResolversTypes['Int'],
    ParentType,
    ContextType,
    RequireFields<Types.INode_RelCountArgs, 'type' | 'target'>
  >
}

export type IscedFieldResolvers<
  ContextType = Context,
  ParentType extends ResolversParentTypes['IscedField'] = ResolversParentTypes['IscedField'],
> = {
  name?: Resolver<ResolversTypes['String'], ParentType, ContextType>
  description?: Resolver<ResolversTypes['String'], ParentType, ContextType>
  ...
  _rel?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<Types.IscedField_RelArgs, 'type' | 'target'>
  >
  _relCount?: Resolver<
    ResolversTypes['Int'],
    ParentType,
    ContextType,
    RequireFields<Types.IscedField_RelCountArgs, 'type' | 'target'>
  >
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>
}

export type IscedGradeResolvers<
  ContextType = Context,
  ParentType extends ResolversParentTypes['IscedGrade'] = ResolversParentTypes['IscedGrade'],
> = {
  name?: Resolver<ResolversTypes['String'], ParentType, ContextType>
  description?: Resolver<ResolversTypes['String'], ParentType, ContextType>
  codePath?: Resolver<Array<ResolversTypes['String']>, ParentType, ContextType>
  ...
  _rel?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<Types.IscedGrade_RelArgs, 'type' | 'target'>
  >
  _relCount?: Resolver<
    ResolversTypes['Int'],
    ParentType,
    ContextType,
    RequireFields<Types.IscedGrade_RelCountArgs, 'type' | 'target'>
  >
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>
}
...
> = {
  ...
  _rel?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<Types.Language_RelArgs, 'type' | 'target'>
  >
  _relCount?: Resolver<
    ResolversTypes['Int'],
    ParentType,
    ContextType,
    RequireFields<Types.Language_RelCountArgs, 'type' | 'target'>
  >
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>
}
...
> = {
  ...
  _rel?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<Types.License_RelArgs, 'type' | 'target'>
  >
  _relCount?: Resolver<
    ResolversTypes['Int'],
    ParentType,
    ContextType,
    RequireFields<Types.License_RelCountArgs, 'type' | 'target'>
  >
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>
}
...
> = {
  changeRecoverPassword?: Resolver<
    Types.Maybe<ResolversTypes['CreateSession']>,
    ParentType,
    ContextType,
    RequireFields<Types.MutationChangeRecoverPasswordArgs, 'newPassword' | 'token'>
  >
  createEdge?: Resolver<
    ResolversTypes['CreateEdgeMutationPayload'],
    ParentType,
    ContextType,
    RequireFields<Types.MutationCreateEdgeArgs, 'input'>
  >
  createNode?: Resolver<
    ResolversTypes['CreateNodeMutationPayload'],
    ParentType,
    ContextType,
    RequireFields<Types.MutationCreateNodeArgs, 'input'>
  >
  createSession?: Resolver<
    ResolversTypes['CreateSession'],
    ParentType,
    ContextType,
    RequireFields<Types.MutationCreateSessionArgs, 'email' | 'password'>
  >
  deleteEdge?: Resolver<
    ResolversTypes['DeleteEdgeMutationPayload'],
    ParentType,
    ContextType,
    RequireFields<Types.MutationDeleteEdgeArgs, 'input'>
  >
  deleteNode?: Resolver<
    ResolversTypes['DeleteNodeMutationPayload'],
    ParentType,
    ContextType,
    RequireFields<Types.MutationDeleteNodeArgs, 'input'>
  >
  editNode?: Resolver<
    ResolversTypes['EditNodeMutationPayload'],
    ParentType,
    ContextType,
    RequireFields<Types.MutationEditNodeArgs, 'input'>
  >
  recoverPassword?: Resolver<
    ResolversTypes['SimpleResponse'],
    ParentType,
    ContextType,
    RequireFields<Types.MutationRecoverPasswordArgs, 'email'>
  >
  sendEmailToProfile?: Resolver<
    ResolversTypes['Boolean'],
    ParentType,
    ContextType,
    RequireFields<Types.MutationSendEmailToProfileArgs, 'text' | 'toProfileId'>
  >
  signUp?: Resolver<
    ResolversTypes['SimpleResponse'],
    ParentType,
    ContextType,
    RequireFields<Types.MutationSignUpArgs, 'email' | 'name' | 'password'>
  >
}
...
> = {
  ...
  _rel?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<Types.Organization_RelArgs, 'type' | 'target'>
  >
  _relCount?: Resolver<
    ResolversTypes['Int'],
    ParentType,
    ContextType,
    RequireFields<Types.Organization_RelCountArgs, 'type' | 'target'>
  >
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>
}
...
export type PinnedResolvers<
  ContextType = Context,
  ParentType extends ResolversParentTypes['Pinned'] = ResolversParentTypes['Pinned'],
> = {
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
  _created?: Resolver<ResolversTypes['Timestamp'], ParentType, ContextType>
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>
...
> = {
  ...
  _rel?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<Types.Profile_RelArgs, 'type' | 'target'>
  >
  _relCount?: Resolver<
    ResolversTypes['Int'],
    ParentType,
    ContextType,
    RequireFields<Types.Profile_RelCountArgs, 'type' | 'target'>
  >
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>
}
...
> = {
  ...
  globalSearch?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<Types.QueryGlobalSearchArgs, 'text'>
  >
  node?: Resolver<
    Types.Maybe<ResolversTypes['Node']>,
    ParentType,
    ContextType,
    RequireFields<Types.QueryNodeArgs, 'id'>
  >
}
...
> = {
  ...
  _rel?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<Types.Resource_RelArgs, 'type' | 'target'>
  >
  _relCount?: Resolver<
    ResolversTypes['Int'],
    ParentType,
    ContextType,
    RequireFields<Types.Resource_RelCountArgs, 'type' | 'target'>
  >
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>
}
...
> = {
  ...
  _rel?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<Types.ResourceType_RelArgs, 'type' | 'target'>
  >
  _relCount?: Resolver<
    ResolversTypes['Int'],
    ParentType,
    ContextType,
    RequireFields<Types.ResourceType_RelCountArgs, 'type' | 'target'>
  >
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>
}
