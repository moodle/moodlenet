import * as GE from 'my-moodlenet-common/lib/content-graph/types/edge'
import * as GN from 'my-moodlenet-common/lib/content-graph/types/node'
import { AssetRef } from 'my-moodlenet-common/lib/graphql/scalars.graphql'
import * as GQL from 'my-moodlenet-common/lib/graphql/types.graphql.gen'
...
import { assertNever } from 'my-moodlenet-common/lib/utils/misc'
