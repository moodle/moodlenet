...
export type AqlGraphNodeData<N extends GraphNode = GraphNode> = DocumentData<DistOmit<N, '_type' | '_permId'>>

export type AqlGraphEdge<E extends GraphEdge = GraphEdge> = Edge<DistOmit<E, 'id' | '_type'>>
export type AqlGraphNode<N extends GraphNode = GraphNode> = Document<DistOmit<N, '_type' | '_permId'>>
