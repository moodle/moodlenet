  ...
  ({ env, toProfileId, text }: SendEmailToProfile) =>
    async ({
      ...
      return sendEmail({
        ...
        /* `Hey ${recipient.name}, ${sender.name}@${domain} sent you a message!` */,
        html: `
        <!DOCTYPE html>
        <html
          lang="en"
                      ...
                      <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                          <td style="padding: 0 2.5em; text-align: center">
                            <div class="text">
                              <h2>{sender.name} sent you a message</h2>
                            </div>
                          </td>
                        </tr>
                        <tr>
                          <td style="text-align: center">
                            <div class="text-author">
                              <span class="position"
                                >{text}</span
                              >
                              <p style="margin: 25px 0"><a href={senderProfileUrl} class="btn btn-primary">Sender profile</a></p>
                            </div>
                          </td>
                        </tr>
                      </table>
                        ...
                        <tr>
                          ...
                          >
                            ...
                            >
                              ...
                              This email was intended for <a href="mailto:{{=it.email}}" target="_blank">{{=it.email}}</a>. This
                              is a service email.
                            </p>
                          </td>
                        </tr>
        ...
        `
        /* `<h2>Moodlenet user ${sender.name} @ ${domain} sent you this message:</h2>
        <p>${text}</p>
        <br/>
        <p>
