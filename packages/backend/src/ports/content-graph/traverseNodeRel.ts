...
import { GraphEdgeType } from 'my-moodlenet-common/lib/content-graph/types/edge'
import { GraphNode, GraphNodeIdentifier, GraphNodeType } from 'my-moodlenet-common/lib/content-graph/types/node'
import { NodeTraversalPage, PaginationInput } from 'my-moodlenet-common/lib/content-graph/types/page'
