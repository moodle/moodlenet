...
export type PassportAuthUserSettingsData = {
  email: string
  password: string
}

export type PassportAuthUserSettingsProps = {
  data: PassportAuthUserSettingsData
  emailChangedSuccess: boolean
  passwordChangedSuccess: boolean
  editData: (values: PassportAuthUserSettingsData) => void
}

export const GeneralMenu = () => <abbr title="General">General</abbr>

export const PassportAuthUserSettings: FC<PassportAuthUserSettingsProps> = ({
  data,
  editData,
  emailChangedSuccess,
  passwordChangedSuccess,
}) => {
  const form = useFormik<PassportAuthUserSettingsData>({
    initialValues: data,
