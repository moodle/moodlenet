...
export type DeleteNodeMutationErrorType = 'NotFound' | 'NotAuthorized' | 'UnexpectedInput' | 'AssertionFailed'
...
export type EdgeType = 'Bookmarked' | 'Created' | 'Features' | 'Follows' | 'Likes' | 'Pinned'
...
export type EditEdgeMutationErrorType = 'NotFound' | 'NotAuthorized' | 'UnexpectedInput' | 'AssertionFailed'
...
const result: PossibleTypesResultData = {
  possibleTypes: {
    ...
    Edge: ['Bookmarked', 'Created', 'Features', 'Follows', 'Likes', 'Pinned'],
    EditEdgeMutationPayload: ['EditEdgeMutationSuccess', 'EditEdgeMutationError'],
    EditNodeMutationPayload: ['EditNodeMutationSuccess', 'EditNodeMutationError'],
    IEdge: ['Bookmarked', 'Created', 'Features', 'Follows', 'Likes', 'Pinned'],
    INode: [
      'Collection',
      'FileFormat',
      'IscedField',
