import { AssetRef, Cursor, Empty, ID, Never, Timestamp } from './scalars.graphql'
...
export type AssetRefInputType = 'TmpUpload' | 'ExternalUrl' | 'NoChange' | 'NoAsset'
...
export type EdgeType = 'Contains' | 'Created' | 'Follows' | 'HasUserRole' | 'Pinned'
...
export type EditNodeMutationErrorType = 'NotFound' | 'NotAuthorized' | 'UnexpectedInput' | 'AssertionFailed'
...
export type GlobalSearchSort = 'Relevance' | 'Popularity' | 'Recent'
...
export type Node = Collection | Iscedf | UserRole | Organization | Profile | Resource

export type NodeType = 'Collection' | 'Iscedf' | 'UserRole' | 'Organization' | 'Profile' | 'Resource'
...
export type RelPageEdge = PageEdge & {
  ...
  node: Collection | Iscedf | UserRole | Organization | Profile | Resource
}
...
const result: PossibleTypesResultData = {
  possibleTypes: {
    ...
    Edge: ['Contains', 'Created', 'Follows', 'HasUserRole', 'Pinned'],
    EditNodeMutationPayload: ['EditNodeMutationSuccess', 'EditNodeMutationError'],
    IEdge: ['Contains', 'Created', 'Follows', 'HasUserRole', 'Pinned'],
    INode: ['Collection', 'Iscedf', 'UserRole', 'Organization', 'Profile', 'Resource'],
    Node: ['Collection', 'Iscedf', 'UserRole', 'Organization', 'Profile', 'Resource'],
    Page: ['RelPage', 'SearchPage'],
    PageEdge: ['RelPageEdge', 'SearchPageEdge'],
