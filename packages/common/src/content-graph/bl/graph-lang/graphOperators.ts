...
export type GraphOperators = {
  graphNode<Type extends GraphNodeType = GraphNodeType>(
    nodeId: null | GraphNodeIdentifier<Type>,
  ): BV<GraphNode<Type> | null>
  graphEdge<Type extends GraphEdgeType = GraphEdgeType>(
    edgeId: null | GraphEdgeIdentifier<Type>,
  ): BV<GraphEdge<Type> | null>
