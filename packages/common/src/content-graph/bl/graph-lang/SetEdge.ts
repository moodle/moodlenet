...
export type SetEdgeAssumptionsFactory = (_: {
...
export type SetEdgeAssumptionsFactoryMap = Partial<
  Record<`${NodeType}_${EdgeType}_${NodeType}`, SetEdgeAssumptionsFactory>
>

export const getSetEdgeAssumptions = async ({
  edge,
  env,
  from,
  map,
  ...
  to: GraphNodeIdentifier
  env: SessionEnv
  map: SetEdgeAssumptionsFactoryMap
  graphOperators: GraphOperators
  baseOperators: BaseOperators
}) => {
