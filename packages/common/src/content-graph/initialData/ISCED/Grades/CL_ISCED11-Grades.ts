...
export const grades = _csv().filter(field => field.code.match(/^ED\d{1,3}$/))
...
function _csv(): Basic_ISCED_Grade[] {
  return [
    ...
    { code: `ED5-7`, desc: `Tertiary education excluding doctoral or equivalent level (levels 5-7)` },
    { code: `ED5_6`, desc: `Short-cycle tertiary education and Bachelor's or equivalent level (levels 5 and 6)` },
    { code: `ED5`, desc: `Short-cycle tertiary education` },
    { code: `ED5SW`, desc: `Short-cycle tertiary education - school and work-based vocational programmes` },
    { code: `ED54`, desc: `Short-cycle tertiary education - general/academic` },
    { code: `ED541`, desc: `Short-cycle tertiary education - general/academic, insufficient for level completion` },
    { code: `ED544`, desc: `Short-cycle tertiary education - general/academic, sufficient for level completion` },
    { code: `ED55`, desc: `Short-cycle tertiary education - vocational/professional` },
    {
      code: `ED551`,
      desc: `Short-cycle tertiary education - vocational/professional, insufficient for level completion`,
    },
    {
      code: `ED554`,
      desc: `Short-cycle tertiary education - vocational/professional, sufficient for level completion`,
    },
    { code: `ED6-8`, desc: `Tertiary education excluding short-cycle tertiary education (levels 6-8)` },
    { code: `ED6`, desc: `Bachelor’s or equivalent level` },
    { code: `ED64`, desc: `Bachelor's or equivalent level - academic` },
    {
      code: `ED641_651_661`,
      desc: `Bachelors's or equivalent level – all programmes, insufficient for level completion (levels 641, 651 and 661)`,
    },
    { code: `ED641`, desc: `Bachelor's or equivalent level - academic, insufficient for level completion` },
    {
      code: `ED645_655_665`,
      desc: `Bachelors's or equivalent level – all programmes, first degree (3-4 years) (levels 645, 655 and 665)`,
    },
    { code: `ED645`, desc: `Bachelor's or equivalent level - academic, first degree (3-4 years)` },
    {
      code: `ED646_656_666`,
      desc: `Bachelors's or equivalent level – all programmes, long first degree (more than 4 years) (levels 646, 656 and 666)`,
    },
    { code: `ED646`, desc: `Bachelor's or equivalent level - academic, long first degree (more than 4 years)` },
    {
      code: `ED647_657_667`,
      desc: `Bachelors's or equivalent level – all programmes, second or further degree (following a Bachelor's or equivalent programme) (levels 647, 657 and 667)`,
    },
    {
      code: `ED647`,
      desc: `Bachelor's or equivalent level - academic, second or further degree (following a Bachelor's or equivalent programme)`,
    },
    { code: `ED65`, desc: `Bachelor's or equivalent level - professional` },
    { code: `ED651`, desc: `Bachelor's or equivalent level - professional, insufficient for level completion` },
    { code: `ED655`, desc: `Bachelor's or equivalent level - professional, first degree (3-4 years)` },
    { code: `ED656`, desc: `Bachelor's or equivalent level - professional, long first degree (more than 4 years)` },
    {
      code: `ED657`,
      desc: `Bachelor's or equivalent level - professional, second or further degree (following a Bachelor's or equivalent programme)`,
    },
    { code: `ED66`, desc: `Bachelor's or equivalent level - orientation unspecified` },
    {
      code: `ED661`,
      desc: `Bachelor's or equivalent level - orientation unspecified, insufficient for level completion`,
    },
    { code: `ED665`, desc: `Bachelor's or equivalent level - orientation unspecified, first degree (3-4 years)` },
    {
      code: `ED666`,
      desc: `Bachelor's or equivalent level - orientation unspecified, long first degree (more than 4 years)`,
    },
    {
      code: `ED667`,
      desc: `Bachelor's or equivalent level - orientation unspecified, second or further degree (following a Bachelor's or equivalent programme)`,
    },
    { code: `ED7_8`, desc: `Master's and Doctoral or equivalent level (levels 7 and 8)` },
    { code: `ED7`, desc: `Master’s or equivalent level` },
    { code: `ED74`, desc: `Master's or equivalent level - academic` },
    {
      code: `ED741_751_761`,
      desc: `Master's or equivalent level – all programmes, insufficient for level completion (levels 741, 751 and 761)`,
    },
    { code: `ED741`, desc: `Master's or equivalent level - academic, insufficient for level completion` },
    {
      code: `ED746_756_766`,
      desc: `Master's or equivalent level – all programmes, long first degree (at least 5 years) (levels 746, 756 and 766)`,
    },
    { code: `ED746`, desc: `Master's or equivalent level - academic, long first degree (at least 5 years)` },
    {
      code: `ED747_757_767`,
      desc: `Master's or equivalent level – all programmes, second or further degree (following a Bachelor's or equivalent programme) (levels 747, 757 and 767)`,
    },
    {
      code: `ED747`,
      desc: `Master's or equivalent level - academic, second or further degree (following a Bachelor's or equivalent programme)`,
    },
    {
      code: `ED748_758_768`,
      desc: `Master's or equivalent level – all programmes, second or further degree (following a Master's or equivalent programme) (levels 748, 758 and 768)`,
    },
    {
      code: `ED748`,
      desc: `Master's or equivalent level - academic, second or further degree (following a Master's or equivalent programme)`,
    },
    { code: `ED75`, desc: `Master's or equivalent level - professional` },
    { code: `ED751`, desc: `Master's or equivalent level - professional, insufficient for level completion` },
    { code: `ED756`, desc: `Master's or equivalent level - professional, long first degree (at least 5 years)` },
    {
      code: `ED757`,
      desc: `Master's or equivalent level - professional, second or further degree (following a Bachelor's or equivalent programme)`,
    },
    {
      code: `ED758`,
      desc: `Master's or equivalent level - professional, second or further degree (following a Master's or equivalent programme)`,
    },
    { code: `ED76`, desc: `Master's or equivalent level - orientation unspecified` },
    {
      code: `ED761`,
      desc: `Master's or equivalent level - orientation unspecified, insufficient for level completion`,
    },
    {
      code: `ED766`,
      desc: `Master's or equivalent level - orientation unspecified, long first degree (at least 5 years)`,
    },
    {
      code: `ED767`,
      desc: `Master's or equivalent level - orientation unspecified, second or further degree (following a Bachelor's or equivalent programme)`,
    },
    {
      code: `ED768`,
      desc: `Master's or equivalent level - orientation unspecified, second or further degree (following a Master's or equivalent programme)`,
    },
    { code: `ED8`, desc: `Doctoral or equivalent level` },
  ]
}
