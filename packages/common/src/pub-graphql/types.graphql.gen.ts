...
const result: PossibleTypesResultData = {
  possibleTypes: {
    ...
    Page: ['SearchPage', 'RelPage'],
    PageEdge: ['SearchPageEdge', 'RelPageEdge'],
    INode: ['Collection', 'Profile', 'Resource', 'Subject'],
    IContentNode: ['Collection', 'Profile', 'Resource', 'Subject'],
    IEdge: ['AppliesTo', 'Contains', 'Created', 'Follows', 'Likes'],
    Edge: ['AppliesTo', 'Contains', 'Created', 'Follows', 'Likes'],
    Node: ['Collection', 'Profile', 'Resource', 'Subject'],
  },
}
