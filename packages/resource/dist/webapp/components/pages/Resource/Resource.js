      ...
      _jsxs(Card, {
        ...
        children: [
          _jsxs('div', {
            ...
            children: [
              _jsxs('div', {
                className: 'type-and-actions',
                children: [
                  _jsxs('span', {
                    className: 'resource-type',
                    children: [
                      _jsx('div', { className: 'resource', children: 'Resource' }),
                      _jsx('div', {
                        className: 'type',
                        style: {
                    ...
                    children: [
                      !isEditing &&
                        _jsxs('div', {
                          ...
                          children: [
                            liked ? _jsx(Favorite, {}) : _jsx(FavoriteBorder, {}),
                            _jsx('span', { children: numLikes }),
                          ],
                        }),
                      isAuthenticated &&
                        !isEditing &&
                        _jsx('div', {
                          ...
                          children: bookmarked ? _jsx(Bookmark, {}) : _jsx(BookmarkBorder, {}),
                        }),
                      isAuthenticated &&
                        !isOwner &&
                        _jsx(FloatingMenu, {
                          ...
                          hoverElement: _jsx(TertiaryButton, {
                            className: `more`,
                            children: '...',
                          }),
                        }),
                                ...
                                // className={`${form.isSubmitting ? 'loading' : ''}`}
                                {
                                  ...
                                  children: [
                                    _jsx('div', {
                                      ...
                                      children: _jsx(Loading, { color: 'white' }),
                                    }),
                                    _jsx('div', {
                                      className: 'label',
                                      style: {
              ...
              isOwner
                ...
                : _jsx('div', { className: 'title' }),
              tags.length > 0 &&
                _jsx('div', { className: 'tags scroll', children: getTagList(tags, 'medium') }),
            ],
          }),
          isOwner
            ? _jsx(InputTextField, {
            ...
            : _jsx('div', { className: 'description' }),
          isEditing &&
            _jsx('div', {
              className: 'bottom',
        ...
        children: [
          ...
          _jsx('a', {
            ...
            children: _jsx(SecondaryButton, {
              children:
                contentType === 'file'
                  ? _jsxs(_Fragment, { children: [_jsx(InsertDriveFile, {}), 'Download file'] })
                  : _jsxs(_Fragment, { children: [_jsx(Link, {}), 'Open link'] }),
            }),
          }),
        ],
      }),
        ...
        children: _jsxs('div', {
          ...
          children: [
            _jsx('div', {
              ...
              children: updatedMainColumnItems.map(i => _jsx(i.Item, {}, i.key)),
            }),
            _jsx('div', {
              className: 'side-column',
              children: updatedSideColumnItems?.map(i => _jsx(i.Item, {}, i.key)),
            }),
          ],
        }),
      }),
