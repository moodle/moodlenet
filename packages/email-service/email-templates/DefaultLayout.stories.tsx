...
const emailBody = `<div class="dialog">
Someone (probably you) requested a password change on {{=it.instanceName}}. If that was you,
please click on the button below and choose a new password for your account.
</div>

<p style="margin: 25px 0">
<a href="{{=it.actionButtonUrl}}" class="btn btn-primary" target="_blank">Change password</a>
</p>
`

const emailTitle = 'Ready to change your password 🔑'
...
function html() {
  return {
                  ...
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                      <td class="logo" style="text-align: center">
                        <h1>
                          <a href="{{=it.domainUrl}}" target="_blank"
                            ><img
                              src="{{=it.instanceLogoUrl}}"
                              alt="Domain logo"
                      ...
                      >
                        ...
                        >
                          <a
                            href="{{=it.locationUrl}}"
                            target="_blank"
                            data-saferedirecturl="{{=it.locationUrl}}"
                            >{{=it.location}}</a
                          >
                        </p>
                        ...
                        >
                          ...
                          <a href="mailto:{{=it.receiverEmail}}" target="_blank"
                            >{{=it.receiverEmail}}</a
    ...
    `
      .replace('{{=it.emailTitle}}', emailTitle)
      .replace('{{=it.emailBody}}', emailBody)
      .replace('{{=it.primary-color}}', '#f88012')
      .replaceAll('{{=it.instanceName}}', 'MoodleNet')
      .replaceAll(
        '{{=it.instanceLogoUrl}}',
        'https://i.ibb.co/cDZ97rk/Moodle-Net-Logo-Colour-RGB.png',
      )
      .replaceAll('{{=it.domainUrl}}', 'https://moodle.net')
      .replaceAll(
        '{{=it.locationUrl}}',
      ...
      .replaceAll('{{=it.receiverEmail}}', 'caterine.z.pons@temail.com')
      .replace('{{=it.actionButtonUrl}}', 'https://moodle.net'),
  }
}
...
const meta: ComponentMeta<typeof Email> = {
  title: 'Pages/Emails/DefaultLayout',
