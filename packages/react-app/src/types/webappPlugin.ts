...
export type WebappRequires<ForExt extends Ext<any, any>> = ForExt extends Ext<any, infer Deps>
  ? {
      [index in keyof Deps]: void | WebappPluginMainModule<Ext<Deps[index]>, unknown>
    }
  : never
...
> = {
  connect(_: { deps: WebPkgDeps<ForExt, Requires> }): MainModuleObj<Lib>
}
