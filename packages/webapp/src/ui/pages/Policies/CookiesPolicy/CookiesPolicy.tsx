  ...
  return (
    <MainPageWrapper {...mainPageWrapperProps}>
      ...
      <div className="cookies-policy">
        ...
        <p>
          <Trans>When you use and access the site, we may place a number of cookie files in your web browser.</Trans>
        </p>
        <p>
          <Trans>
            MoodleNet uses or may use cookies and/or web beacons to help us determine and identify repeat visitors, the
            type of content and sites to which a user of our site links, the length of time each user spends on any
            particular area of our site, and the specific functionalities that users choose to use. To the extent that
            cookie data constitutes personally identifiable information, we process such data on the basis of your
            consent.
          </Trans>
        </p>
        <p>
          <Trans>
            We use both session and persistent cookies on the site and we use different types of cookies to run the
            site:
          </Trans>
        </p>
        <ul>
          <li>
            <Trans>
              <i>Essential cookies</i>. Necessary for the operation of the site. We may use essential cookies to
              authenticate users, prevent fraudulent use of user accounts, or offer site features.
            </Trans>
          </li>
          <li>
            <Trans>
              <i>Analytical/performance cookies</i>. Allow us to recognise and count the number of visitors and see how
              visitors move around the site when using it. This helps us improve the way the site works.
            </Trans>
          </li>
          <li>
            <Trans>
              <i>Functionality cookies</i>. Used to recognise you when you return to the site. This enables us to
          ...
          <li>
            <Trans>
              <i>Targeting cookies</i>. Record your visit to the site, the pages you have visited, and the links you
              have followed. We will use this information to make the site more relevant to your interests. We may also
        ...
        <p>
          <Trans>
            To view a list of Moodle cookies, please view our <a href="#cookies-table">Cookies table</a>.
          </Trans>
        </p>
        <h2>
        ...
        <p>
          <Trans>
            ...
            the Site and refine marketing efforts.
          </Trans>
        </p>
        <ul>
          <li>
            <Trans>
              <i>Tracking cookies</i>. Follow on-site behaviour and tie it to other metrics allowing better
              understanding of usage habits.
            </Trans>
          </li>
          <li>
            <Trans>
              <i>Optimization cookies</i>. Allow real-time tracking of user conversion from different marketing channels
              to evaluate their effectiveness.
            </Trans>
          </li>
          <li>
            <Trans>
              <i>Partner cookies</i>. Provide marketing conversion metrics to our partners so they can optimize their
        ...
        <p>
          <Trans>
            ...
            you might not be able to use some or all of the features we offer. You may not be able to log in, store your
        ...
        <p>
          <Trans>
            The tables below list some of the internal and third-party cookies we use. As the names, numbers, and
            purposes of these cookies may change over time, this page may be updated to reflect those changes.
          </Trans>
        </p>
        <h2>
          <Trans>Third-party cookies</Trans>
        ...
        <table>
          <tbody>
            ...
            <tr>
              ...
              <td>
                <Trans>
                  Used to throttle request rate. If Google Analytics is deployed via Google Tag Manager, this cookie
            ...
            <tr>
              ...
              <td>
                <Trans>
                  Contains campaign related information for the user. If you have linked your Google Analytics and
                  Google Ads accounts, Google Ads website conversion tags will read this cookie unless you opt-out.
                  Learn more.
                </Trans>
              </td>
            </tr>
