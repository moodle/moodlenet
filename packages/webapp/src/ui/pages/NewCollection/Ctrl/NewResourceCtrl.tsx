...
import { UploadResourceProps } from '../CreateCollection/CreateCollection'
...
import {
  ...
  useNewCollectionDataPageLazyQuery
} from './NewCollectionCtrl.gen'
...
export const useNewCollectionCtrl: CtrlHook<NewCollectionProps, NewCollectionCtrlProps> = () => {
  ...
  const [loadMyColl, mycollectionsQRes] = useNewCollectionDataPageLazyQuery()
  ...
  type StepProps = DistOmit<NewCollectionProps['stepProps'], 'nextStep'>
