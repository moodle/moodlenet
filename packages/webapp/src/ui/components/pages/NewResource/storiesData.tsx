export const CategoriesDropdown: [string, string][] = [
  ...
  [
    `0688`,
    `Inter-disciplinary programmes and qualifications involving Information and Communication Technologies (ICTs) Broad field Narrow field Detailed field`,
  ],
