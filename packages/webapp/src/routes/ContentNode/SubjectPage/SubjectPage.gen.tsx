...
export type SubjectPageFollowMutation = (
  { __typename: 'Mutation' }
  & { createEdge: (
...
export type SubjectPageUnfollowMutation = (
  { __typename: 'Mutation' }
  & { deleteEdge: (
...
export const SubjectPageFollowDocument = gql`
  ...
  createEdge(
    input: {edgeType: Follows, from: $currentProfileId, to: $subjectId, Follows: {}}
  ) {
    ...BasicCreateEdgeMutationPayload
  }
}
    ${BasicCreateEdgeMutationPayloadFragmentDoc}`;
export type SubjectPageFollowMutationFn = Apollo.MutationFunction<SubjectPageFollowMutation, SubjectPageFollowMutationVariables>;
 ...
 * });
 */
export function useSubjectPageFollowMutation(baseOptions?: Apollo.MutationHookOptions<SubjectPageFollowMutation, SubjectPageFollowMutationVariables>) {
        return Apollo.useMutation<SubjectPageFollowMutation, SubjectPageFollowMutationVariables>(SubjectPageFollowDocument, baseOptions);
      }
...
export type SubjectPageFollowMutationOptions = Apollo.BaseMutationOptions<SubjectPageFollowMutation, SubjectPageFollowMutationVariables>;
...
export type SubjectPageUnfollowMutationFn = Apollo.MutationFunction<SubjectPageUnfollowMutation, SubjectPageUnfollowMutationVariables>;
 ...
 * });
 */
export function useSubjectPageUnfollowMutation(baseOptions?: Apollo.MutationHookOptions<SubjectPageUnfollowMutation, SubjectPageUnfollowMutationVariables>) {
        return Apollo.useMutation<SubjectPageUnfollowMutation, SubjectPageUnfollowMutationVariables>(SubjectPageUnfollowDocument, baseOptions);
      }
...
export type SubjectPageUnfollowMutationOptions = Apollo.BaseMutationOptions<SubjectPageUnfollowMutation, SubjectPageUnfollowMutationVariables>;