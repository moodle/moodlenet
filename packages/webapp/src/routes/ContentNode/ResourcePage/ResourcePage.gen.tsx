...
export type ResourcePageFollowMutation = (
  { __typename: 'Mutation' }
  & { createEdge: (
...
export type ResourcePageUnfollowMutation = (
  { __typename: 'Mutation' }
  & { deleteEdge: (
...
export const ResourcePageFollowDocument = gql`
  ...
  createEdge(
    input: {edgeType: Follows, from: $currentProfileId, to: $resourceId, Follows: {}}
  ) {
    ...BasicCreateEdgeMutationPayload
  }
}
    ${BasicCreateEdgeMutationPayloadFragmentDoc}`;
export type ResourcePageFollowMutationFn = Apollo.MutationFunction<ResourcePageFollowMutation, ResourcePageFollowMutationVariables>;
 ...
 * });
 */
export function useResourcePageFollowMutation(baseOptions?: Apollo.MutationHookOptions<ResourcePageFollowMutation, ResourcePageFollowMutationVariables>) {
        return Apollo.useMutation<ResourcePageFollowMutation, ResourcePageFollowMutationVariables>(ResourcePageFollowDocument, baseOptions);
      }
...
export type ResourcePageFollowMutationOptions = Apollo.BaseMutationOptions<ResourcePageFollowMutation, ResourcePageFollowMutationVariables>;
...
export type ResourcePageUnfollowMutationFn = Apollo.MutationFunction<ResourcePageUnfollowMutation, ResourcePageUnfollowMutationVariables>;
 ...
 * });
 */
export function useResourcePageUnfollowMutation(baseOptions?: Apollo.MutationHookOptions<ResourcePageUnfollowMutation, ResourcePageUnfollowMutationVariables>) {
        return Apollo.useMutation<ResourcePageUnfollowMutation, ResourcePageUnfollowMutationVariables>(ResourcePageUnfollowDocument, baseOptions);
      }
...
export type ResourcePageUnfollowMutationOptions = Apollo.BaseMutationOptions<ResourcePageUnfollowMutation, ResourcePageUnfollowMutationVariables>;