...
export type ProfilePageNodeQuery = { __typename: 'Query' } & {
  node?: Types.Maybe<
    | { __typename: 'Collection' }
    | ({ __typename: 'Profile' } & Pick<Types.Profile, '_id' | 'name' | 'icon' | 'summary'> & {
              ...
              relCount?: Types.Maybe<
                { __typename: 'RelCountMap' } & {
                  ...
                  Created?: Types.Maybe<
                    { __typename: 'RelCount' } & {
                      to?: Types.Maybe<
                        { __typename: 'RelCountTargetMap' } & Pick<Types.RelCountTargetMap, 'Resource' | 'Collection'>
                      >
                    }
                  >
                }
...
export type ProfilePageOwnCollectionsQuery = { __typename: 'Query' } & {
  node?: Types.Maybe<
    | ({ __typename: 'Collection' } & Pick<Types.Collection, '_id'> & {
          ownCollections: { __typename: 'RelPage' } & {
            edges: Array<
              { __typename: 'RelPageEdge' } & {
                node:
...
export type ProfilePageOwnResourcesQuery = { __typename: 'Query' } & {
  node?: Types.Maybe<
    | ({ __typename: 'Collection' } & Pick<Types.Collection, '_id'> & {
          ownResources: { __typename: 'RelPage' } & {
            edges: Array<
              { __typename: 'RelPageEdge' } & {
                node:
                  | { __typename: 'Collection' }
...
export type ProfilePageFollowMutation = { __typename: 'Mutation' } & {
  createEdge:
...
export type ProfilePageUnfollowMutation = { __typename: 'Mutation' } & {
  deleteEdge:
 ...
 * });
 */
export function useProfilePageNodeQuery(
  baseOptions: Apollo.QueryHookOptions<ProfilePageNodeQuery, ProfilePageNodeQueryVariables>,
) {
  return Apollo.useQuery<ProfilePageNodeQuery, ProfilePageNodeQueryVariables>(ProfilePageNodeDocument, baseOptions)
}
export function useProfilePageNodeLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<ProfilePageNodeQuery, ProfilePageNodeQueryVariables>,
) {
 ...
 * });
 */
export function useProfilePageOwnCollectionsQuery(
  baseOptions: Apollo.QueryHookOptions<ProfilePageOwnCollectionsQuery, ProfilePageOwnCollectionsQueryVariables>,
) {
  return Apollo.useQuery<ProfilePageOwnCollectionsQuery, ProfilePageOwnCollectionsQueryVariables>(
    ProfilePageOwnCollectionsDocument,
    baseOptions,
  )
}
export function useProfilePageOwnCollectionsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<ProfilePageOwnCollectionsQuery, ProfilePageOwnCollectionsQueryVariables>,
) {
  return Apollo.useLazyQuery<ProfilePageOwnCollectionsQuery, ProfilePageOwnCollectionsQueryVariables>(
    ProfilePageOwnCollectionsDocument,
    baseOptions,
  )
}
...
export type ProfilePageOwnCollectionsQueryResult = Apollo.QueryResult<
  ProfilePageOwnCollectionsQuery,
  ProfilePageOwnCollectionsQueryVariables
>
 ...
 * });
 */
export function useProfilePageOwnResourcesQuery(
  baseOptions: Apollo.QueryHookOptions<ProfilePageOwnResourcesQuery, ProfilePageOwnResourcesQueryVariables>,
) {
  return Apollo.useQuery<ProfilePageOwnResourcesQuery, ProfilePageOwnResourcesQueryVariables>(
    ProfilePageOwnResourcesDocument,
    baseOptions,
  )
}
export function useProfilePageOwnResourcesLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<ProfilePageOwnResourcesQuery, ProfilePageOwnResourcesQueryVariables>,
) {
  return Apollo.useLazyQuery<ProfilePageOwnResourcesQuery, ProfilePageOwnResourcesQueryVariables>(
    ProfilePageOwnResourcesDocument,
    baseOptions,
  )
}
...
export type ProfilePageOwnResourcesQueryResult = Apollo.QueryResult<
  ProfilePageOwnResourcesQuery,
  ProfilePageOwnResourcesQueryVariables
>
...
`
export type ProfilePageFollowMutationFn = Apollo.MutationFunction<
  ProfilePageFollowMutation,
  ProfilePageFollowMutationVariables
>
 ...
 * });
 */
export function useProfilePageFollowMutation(
  baseOptions?: Apollo.MutationHookOptions<ProfilePageFollowMutation, ProfilePageFollowMutationVariables>,
) {
  return Apollo.useMutation<ProfilePageFollowMutation, ProfilePageFollowMutationVariables>(
    ProfilePageFollowDocument,
    baseOptions,
  )
}
...
export type ProfilePageFollowMutationOptions = Apollo.BaseMutationOptions<
  ProfilePageFollowMutation,
  ProfilePageFollowMutationVariables
>
...
`
export type ProfilePageUnfollowMutationFn = Apollo.MutationFunction<
  ProfilePageUnfollowMutation,
  ProfilePageUnfollowMutationVariables
>
 ...
 * });
 */
export function useProfilePageUnfollowMutation(
  baseOptions?: Apollo.MutationHookOptions<ProfilePageUnfollowMutation, ProfilePageUnfollowMutationVariables>,
) {
  return Apollo.useMutation<ProfilePageUnfollowMutation, ProfilePageUnfollowMutationVariables>(
    ProfilePageUnfollowDocument,
    baseOptions,
  )
}
...
export type ProfilePageUnfollowMutationOptions = Apollo.BaseMutationOptions<
  ProfilePageUnfollowMutation,
  ProfilePageUnfollowMutationVariables
>
