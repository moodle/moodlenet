...
export type GetCurrentSessionQuery = { __typename: 'Query' } & {
  getSession?: Types.Maybe<{ __typename: 'UserSession' } & UserSessionFragment>
}

export type UserSessionFragment = { __typename: 'UserSession' } & Pick<Types.UserSession, 'email'> & {
    profile: { __typename: 'Profile' } & Pick<Types.Profile, 'id' | 'name' | 'avatar'> & {
