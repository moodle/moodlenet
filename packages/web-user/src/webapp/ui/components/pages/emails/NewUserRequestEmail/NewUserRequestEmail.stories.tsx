                  ...
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                      <td style="padding: 0 2.5em; text-align: center">
                        <div class="text">
                          <h2>Welcome to {{=it.instance-name}} 🎉</h2>
                        </div>
                      </td>
                    </tr>
                    <tr>
                      <td style="text-align: center">
                        <div class="text-author">
                          <div class="dialog">
                            Thanks for signing up to {{=it.instance-name}}! Click the button below to activate your
                            account.
                          </div>
...
export const Default: typeof NewUserRequestEmailStory = NewUserRequestEmailStory.bind({})
