// @index(['../ui/**/*.stories.*'], f => `export * as ${f.name.replace('.stories','Stories')} from '${f.path}${f.ext==='.tsx'?'.js':f.ext==='.mts'?'.mjs':f.ext}'`)
export * as AccessButtonsStories from '../ui/components/molecules/AccessButtons/AccessButtons.stories.js'
export * as AvatarMenuStories from '../ui/components/molecules/AvatarMenu/AvatarMenu.stories.js'
export * as MinimalisticAccessButtonsStories from '../ui/components/molecules/MinimalisticAccessButtons/MinimalisticAccessButtons.stories.js'
