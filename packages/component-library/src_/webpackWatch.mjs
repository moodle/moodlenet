...
baseResolveAlias, }) {
    ...
    wp.hooks.afterDone.tap('swap folders', async (wpStats) => {
        ...
        await new Promise((resolve, reject) => rimraf(latestBuildFolder, { disableGlob: true }, e => (e ? reject(e) : resolve())));
...
//# sourceMappingURL=webpackWatch.mjs.map