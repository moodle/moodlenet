...
import getBloomsCognitivesFineTuning from './meta-data/bloomsCognitivesFineTuning'
import getIscedFields4CharsFineTuning from './meta-data/iscedFields4CharsFineTuning'
import getIscedGradesFineTuning from './meta-data/iscedGradesFineTuning'
import getLangFineTuning from './meta-data/langFineTuning'
import getLicenseFineTuning from './meta-data/licenseFineTuning'
import getResTypeFineTuning from './meta-data/resTypeFineTuning'
import { FN_NAME } from './types'
export default async function () {
  ...
  const systemMsgStrings: string[] = [
    ...
    `you will be given a text ingested from an educational resource,
