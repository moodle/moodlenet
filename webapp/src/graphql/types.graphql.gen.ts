...
const result: PossibleTypesResultData = {
  possibleTypes: {
    CreateNodeMutationPayload: ['CreateNodeMutationSuccess', 'CreateNodeMutationError'],
    CreateEdgeMutationPayload: ['CreateEdgeMutationSuccess', 'CreateEdgeMutationError'],
    UpdateNodeMutationPayload: ['UpdateNodeMutationSuccess', 'UpdateNodeMutationError'],
    UpdateEdgeMutationPayload: ['UpdateEdgeMutationSuccess', 'UpdateEdgeMutationError'],
    DeleteEdgeMutationPayload: ['DeleteEdgeMutationSuccess', 'DeleteEdgeMutationError'],
    DeleteNodeMutationPayload: ['DeleteNodeMutationSuccess', 'DeleteNodeMutationError'],
    INode: ['Subject', 'User'],
    IEdge: ['Follows'],
    Edge: ['Follows'],
    Node: ['Subject', 'User'],
...
export type ResolversTypes = {
  ...
  CreateNodeMutationSuccess: ResolverTypeWrapper<
    Omit<CreateNodeMutationSuccess, 'node'> & { node: Maybe<ResolversTypes['Node']> }
  >
  ...
  CreateEdgeMutationSuccess: ResolverTypeWrapper<
    Omit<CreateEdgeMutationSuccess, 'edge'> & { edge: Maybe<ResolversTypes['Edge']> }
  >
  ...
  DeleteEdgeMutationSuccess: ResolverTypeWrapper<
    Omit<DeleteEdgeMutationSuccess, 'edge'> & { edge: Maybe<ResolversTypes['Edge']> }
  >
  ...
  DeleteNodeMutationSuccess: ResolverTypeWrapper<
    Omit<DeleteNodeMutationSuccess, 'node'> & { node: Maybe<ResolversTypes['Node']> }
  >
...
export type ResolversParentTypes = {
  ...
  CreateNodeMutationSuccess: Omit<CreateNodeMutationSuccess, 'node'> & {
    node: Maybe<ResolversParentTypes['Node']>
  }
  ...
  CreateEdgeMutationSuccess: Omit<CreateEdgeMutationSuccess, 'edge'> & {
    edge: Maybe<ResolversParentTypes['Edge']>
  }
  ...
  UpdateNodeMutationSuccess: Omit<UpdateNodeMutationSuccess, 'node'> & {
    node: Maybe<ResolversParentTypes['Node']>
  }
  ...
  UpdateEdgeMutationSuccess: Omit<UpdateEdgeMutationSuccess, 'edge'> & {
    edge: Maybe<ResolversParentTypes['Edge']>
  }
  ...
  DeleteEdgeMutationSuccess: Omit<DeleteEdgeMutationSuccess, 'edge'> & {
    edge: Maybe<ResolversParentTypes['Edge']>
  }
  ...
  DeleteNodeMutationSuccess: Omit<DeleteNodeMutationSuccess, 'node'> & {
    node: Maybe<ResolversParentTypes['Node']>
  }
...
> = {
  activateAccount: Resolver<
    ResolversTypes['ActivationOutcome'],
    ParentType,
    ContextType,
    RequireFields<MutationActivateAccountArgs, 'username' | 'password' | 'token'>
  >
  changeEmailConfirm: Resolver<
    ResolversTypes['Boolean'],
    ParentType,
    ContextType,
    RequireFields<MutationChangeEmailConfirmArgs, 'token' | 'password' | 'username'>
  >
  ...
  changePassword: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<MutationChangePasswordArgs, 'newPassword' | 'currentPassword'>
  >
  createEdge: Resolver<
  ...
  createSession: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<MutationCreateSessionArgs, 'username' | 'password'>
  >
  deleteEdge: Resolver<
  ...
  >
  sessionByEmail: Resolver<
    ResolversTypes['SimpleResponse'],
    ParentType,
    ContextType,
    RequireFields<MutationSessionByEmailArgs, 'username' | 'email'>
  >
  signUp: Resolver<
    ResolversTypes['SimpleResponse'],
    ParentType,
...
> = {
  ...
  getSessionAccountUser: Resolver<
    Maybe<ResolversTypes['UserSession']>,
    ParentType,
    ContextType,
    RequireFields<QueryGetSessionAccountUserArgs, 'username'>
  >
  node: Resolver<
    Maybe<ResolversTypes['Node']>,
    ParentType,
    ContextType,
    RequireFields<QueryNodeArgs, '_id' | 'nodeType'>
  >
}
...
export type ByAtResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes['ByAt'] = ResolversParentTypes['ByAt']
> = {
...
export type ActivationOutcomeResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes['ActivationOutcome'] = ResolversParentTypes['ActivationOutcome']
> = {
