...
export type ResolversParentTypes = {
  ...
  ID: Scalars['ID']
  Edge:
    | ResolversParentTypes['UserFollowsSubject']
    | ResolversParentTypes['UserFollowsUser']
  InputCursor: InputCursor
  PageInput: PageInput
  Int: Scalars['Int']
...
> = {
  __resolveType: TypeResolveFn<
    'UserFollowsSubject' | 'UserFollowsUser',
    ParentType,
    ContextType
  >
  _id: Resolver<ResolversTypes['ID'], ParentType, ContextType>
...
export type UserFollowsSubjectResolvers<
  ContextType = MoodleNetGraphQLContext,
  ParentType extends ResolversParentTypes['UserFollowsSubject'] = ResolversParentTypes['UserFollowsSubject']
> = {
  _id: Resolver<ResolversTypes['ID'], ParentType, ContextType>
...
> = {
  _id: Resolver<ResolversTypes['ID'], ParentType, ContextType>
  followers: Resolver<
    Array<ResolversTypes['UserFollowsUser']>,
    ParentType,
    ContextType,
    RequireFields<UserFollowersArgs, never>
  >
  followsSubjects: Resolver<
    Array<ResolversTypes['UserFollowsSubject']>,
    ParentType,
    ContextType,
    RequireFields<UserFollowsSubjectsArgs, never>
  >
  followsUsers: Resolver<
    Array<ResolversTypes['UserFollowsUser']>,
    ParentType,
    ContextType,
    RequireFields<UserFollowsUsersArgs, never>
  >
...
> = {
  ...
  followers: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<SubjectFollowersArgs, never>
  >
  name: Resolver<ResolversTypes['String'], ParentType, ContextType>
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>
}
...
> = {
  createSubject: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<MutationCreateSubjectArgs, 'subjectInput'>
  >
  createUser: Resolver<
    ResolversTypes['User'],
    ParentType,
  ...
  >
  followSubject: Resolver<
    Maybe<ResolversTypes['UserFollowsSubject']>,
    ParentType,
    ContextType,
    RequireFields<MutationFollowSubjectArgs, never>
  >
  followUser: Resolver<
    Maybe<ResolversTypes['UserFollowsUser']>,
    ParentType,
    ContextType,
    RequireFields<MutationFollowUserArgs, never>
  >
}

export type UserFollowsUserResolvers<
  ContextType = MoodleNetGraphQLContext,
  ParentType extends ResolversParentTypes['UserFollowsUser'] = ResolversParentTypes['UserFollowsUser']
> = {
  _id: Resolver<ResolversTypes['ID'], ParentType, ContextType>
  _from: Resolver<Maybe<ResolversTypes['User']>, ParentType, ContextType>
...
> = {
  subject: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<QuerySubjectArgs, '_id'>
  >
  user: Resolver<
