...
import { eduBloomCognitive, eduIscedFieldCode, eduIscedLevelCode, eduResourceTypeCode } from './edu-categories'
...
export type eduPrimaryEnabledCategoriesSchemaConfigs = {
  ...
  eduBloomCognitives: { enabled: Pick<eduBloomCognitive, 'verbs' | 'level'>[] }
}
