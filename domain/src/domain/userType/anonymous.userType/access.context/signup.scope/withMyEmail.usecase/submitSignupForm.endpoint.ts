...
export type submitSignupForm = moo.def.userType.endpoint<[typeof signupFormZodSchema, E.Either<never, typeof SUBMITTED>]>
...
export const submitSignupForm: moo.def.gate.provider.endpoint<submitSignupForm> = flow(
  O.some,
  O.bind(`general`, ({ policiesInfo }) => O.fromNullable(policiesInfo.tree.any?._.schemas.general)),
