...
export type requestLink = moo.def.userType.endpoint<[typeof requestLinkSchema, void]>
export const requestLink: moo.def.gate.provider.endpoint<requestLink> = flow(
  O.some,
