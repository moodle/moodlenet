...
export type login = moo.def.userType.endpoint<[typeof loginFormZodSchema, E.Either<WRONG_CREDENTIALS, { authSessionToken: signed_token }>]>
export const login: moo.def.gate.provider.endpoint<login> = flow(
  O.some,
