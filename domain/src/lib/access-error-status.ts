...
export function statusByDescOrCode4xx(code_or_desc: status_desc_4xx | status_code_4xx): status_code_4xx {
  return code_or_desc in status_code_by_desc_4xx
    ? (status_code_by_desc_4xx as any_)[code_or_desc]
...
export const status_code_by_desc_4xx = Object.fromEntries(status_list_4xx) as Record<status_desc_4xx, status_code_4xx>
export const status_desc_by_code_4xx = Object.fromEntries(status_list_4xx.map(([name, code]) => [code, name])) as Record<
  status_code_4xx,
  status_desc_4xx
>
...
// export type status_code = status_code_2xx | status_code_xxx
